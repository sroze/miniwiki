...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // _assetic_fd0bfca
        if ($pathinfo === '/js/fd0bfca.js') {
            return array (  '_controller' => 'assetic.controller:render',  'name' => 'fd0bfca',  'pos' => NULL,  '_format' => 'js',  '_route' => '_assetic_fd0bfca',);
        }

        // _assetic_fd0bfca_0
        if ($pathinfo === '/js/fd0bfca_jquery-1.7.2.min_1.js') {
            return array (  '_controller' => 'assetic.controller:render',  'name' => 'fd0bfca',  'pos' => 0,  '_format' => 'js',  '_route' => '_assetic_fd0bfca_0',);
        }

        // _assetic_cc79484
        if ($pathinfo === '/js/cc79484.js') {
            return array (  '_controller' => 'assetic.controller:render',  'name' => 'cc79484',  'pos' => NULL,  '_format' => 'js',  '_route' => '_assetic_cc79484',);
        }

        // _assetic_cc79484_0
        if ($pathinfo === '/js/cc79484_bootstrap_1.js') {
            return array (  '_controller' => 'assetic.controller:render',  'name' => 'cc79484',  'pos' => 0,  '_format' => 'js',  '_route' => '_assetic_cc79484_0',);
        }

        // _assetic_f721e0c
        if ($pathinfo === '/css/f721e0c.css') {
            return array (  '_controller' => 'assetic.controller:render',  'name' => 'f721e0c',  'pos' => NULL,  '_format' => 'css',  '_route' => '_assetic_f721e0c',);
        }

        // _assetic_f721e0c_0
        if ($pathinfo === '/css/f721e0c_bootstrap_1.css') {
            return array (  '_controller' => 'assetic.controller:render',  'name' => 'f721e0c',  'pos' => 0,  '_format' => 'css',  '_route' => '_assetic_f721e0c_0',);
        }

        // _assetic_f721e0c_1
        if ($pathinfo === '/css/f721e0c_24h_2.css') {
            return array (  '_controller' => 'assetic.controller:render',  'name' => 'f721e0c',  'pos' => 1,  '_format' => 'css',  '_route' => '_assetic_f721e0c_1',);
        }
